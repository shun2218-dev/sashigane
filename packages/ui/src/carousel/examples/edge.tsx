...
export default function Edge() {
  return (
    <div style={{ display: 'grid', gap: 24, maxWidth: 420 }}>
      ...
      <Carousel label="自動でスクロールするもの" autoplay options={{ loop: true }}>
        <CarouselSlides>
          {['一', '二', '三'].map((n) => (
            <CarouselSlide key={n}>
              <Card>{n}枚目</Card>
        ...
        {/*
          **停止ボタンは、前後のボタンの代わりではない。** 4つとも別の役目を持つ。
