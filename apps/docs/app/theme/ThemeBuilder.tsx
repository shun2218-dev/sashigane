...
export const ThemeBuilder = () => {
  ...
  /**
   * 独立したデモページへ渡すもの。**埋め込まないので状態はここに残らない。**
  ...
  return (
    <main>
      ...
      {/*
        **デモページは埋め込まない。** 独立した URL を開く（決定6-4 の改訂）。
        ...
        **見出しのある区画に入れ、リンクをボタンの形にしている。**
        以前は素の <a> を操作列の下に置いていただけで、埋もれて見つからなかった。
      */}
      <section>
        <h2>デモ</h2>
        <p className="explain">
          いま選んでいる色でページを1枚組み、<strong>別のタブで開きます。</strong>
          素の CSS だけで書かれていて、React を通りません。
        </p>
        ...
        <p>
          <a className="demo-link" href={demoHref} target="_blank" rel="noreferrer">
            このテーマでデモページを開く →
          </a>
        </p>
        <p className="note">
          密度は画面幅に従うのが既定です。画面幅そのものは、開いた先の
          ブラウザ窓を狭めれば確かめられます。
        </p>
      </section>
